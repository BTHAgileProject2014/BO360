...
bool BOHUDManager::m_levelsEnabled;
bool BOHUDManager::m_hudEnabled;
...
bool BOHUDManager::Initialize(bool p_enabled)
{
	m_hudEnabled = p_enabled;
	...
	m_level.Initialize(m_levelAnchor, "Level: ", int3(255, 255, 255));
	m_lives.Initialize(m_livesAnchor, "Lives: ", int3(255, 255, 255));
	m_score.Initialize(m_scoreAnchor, "Score: ", int3(255, 255, 255));
...
void BOHUDManager::ModeState(bool p_lives, bool p_score, bool p_levels)
{
	...
	m_levelsEnabled = p_levels;
}

void BOHUDManager::EnableHud(bool p_enable)
{
	m_hudEnabled = p_enable;
}
