...
// Pad. Generates a new direction for the ball if it hits the pad. Returns (0,0) if there is no collision.
...
// Calculates the bounce around a biased angle. Returns (0,0) if there is no collision.
